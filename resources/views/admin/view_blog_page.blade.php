                    ...
                    <table>
                        ...
                        @foreach ($blog as $blog)
                            <tr>
                                ...
                                <td>
                                    <img class="blog_img"
                                        src="blogImage/{{ $blog->blog_img }}" alt="">
                                </td>
                                ...
                                <td>
                                    <img class="bloger_img"
                                        src="blogerImage/{{ $blog->bloger_img }}" alt="">
                                </td>
                               
                                <td>
                                    <a class="btn btn-secondary" href="{{ url('edit_blog', $blog->id) }}">Update</a>
                                </td>

                                <td>
                                    <a class="btn btn-danger" onclick="return confirm('Are you sure to delete this Blog?')" href="{{ url('delete_blog', $blog->id) }}">Delete</a>
                                </td>
